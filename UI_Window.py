...
"color : rgb(2, 65, 132);")
        ...
        self.wienerButton = QtWidgets.QPushButton(self.groupBox_6)

        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pushButton_uploadButton.sizePolicy().hasHeightForWidth())
        sizePolicy.setHeightForWidth(self.wienerButton.sizePolicy().hasHeightForWidth())
        self.pushButton_uploadButton.setSizePolicy(sizePolicy)
        self.wienerButton.setSizePolicy(sizePolicy)
        ...
        self.wienerButton.setMinimumSize(QtCore.QSize(280, 36))
        self.wienerButton.setMaximumSize(QtCore.QSize(150, 16777215))
        font = QtGui.QFont()
        ...
        self.wienerButton.setFont(font)
        icon6 = QtGui.QIcon()
        ...
        self.wienerButton.setObjectName("wiener")
        self.gridLayout_32.addWidget(self.pushButton_uploadButton, 2, 0, 1, 1)
        self.gridLayout_32.addWidget(self.wienerButton, 3, 0, 1, 1)
        ...
        self.actionWiener.setIcon(icon15)
        font = QtGui.QFont()
        font.setFamily("Yu Gothic UI")
        font.setPointSize(15)
        font.setBold(True)
        font.setWeight(75)
        self.actionWiener.setFont(font)
        ...
        self.actionWiener.triggered['bool'].connect(self.verticalSlider_1.hide) # type: ignore
        self.actionWiener.triggered['bool'].connect(self.label_1_Hz.hide) # type: ignore
        self.actionWiener.triggered['bool'].connect(self.verticalSlider_2.hide) # type: ignore
        self.actionWiener.triggered['bool'].connect(self.label_2_Hz.hide) # type: ignore
        self.actionWiener.triggered['bool'].connect(self.verticalSlider_3.hide) # type: ignore
        self.actionWiener.triggered['bool'].connect(self.label_3_Hz.hide) # type: ignore
        self.actionWiener.triggered['bool'].connect(self.verticalSlider_4.hide) # type: ignore
        self.actionWiener.triggered['bool'].connect(self.label_4_Hz.hide) # type: ignore
        self.actionWiener.triggered['bool'].connect(self.verticalSlider_5.hide) # type: ignore
        self.actionWiener.triggered['bool'].connect(self.label_5_Hz.hide) # type: ignore
        self.actionWiener.triggered['bool'].connect(self.verticalSlider_6.hide) # type: ignore
        self.actionWiener.triggered['bool'].connect(self.label_6_Hz.hide) # type: ignore
        self.actionWiener.triggered['bool'].connect(self.verticalSlider_7.hide) # type: ignore
        self.actionWiener.triggered['bool'].connect(self.label_7_Hz.hide) # type: ignore
        self.actionWiener.triggered['bool'].connect(self.verticalSlider_8.show) # type: ignore
        self.actionWiener.triggered['bool'].connect(self.label_8_Hz.show) # type: ignore
        self.actionWiener.triggered['bool'].connect(self.verticalSlider_9.show) # type: ignore
        self.actionWiener.triggered['bool'].connect(self.label_9_Hz.show) # type: ignore
        self.actionWiener.triggered['bool'].connect(self.verticalSlider_10.show) # type: ignore
        self.actionWiener.triggered['bool'].connect(self.label_10_Hz.show) # type: ignore
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.wienerButton.setText(_translate("MainWindow", "Apply Wiener"))
        ...
        self.comboBox_modeSelection.setItemText(3, _translate("MainWindow", "Wiener Filter"))
        ...
        self.actionWiener.setText(_translate("MainWindow", "Wiener Filter"))
